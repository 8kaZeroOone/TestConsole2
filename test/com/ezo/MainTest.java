...
class MainTest {
    ...
    void main() {
        ...
        int expected1 = 3; //ожидаемый результат 3
        ...
        int expected2 = 0; //ожидаемый результат 0
        assertEquals(expected2,actual2); //сравниваем полученные результаты

        int actual3 = counter.symbols("How are you, Alexander?"); //передаём тестовое сообщение в Counter
        int expected3 = 3; //ожидаемый результат 3
